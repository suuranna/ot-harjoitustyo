...
#omat testit
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_kortilla_on_rahaa_vain_sen_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_kortilla_on_rahaa_vain_sen_verran(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
